...
# Description 
There are 5 questions in this practical based on data query language(The SQL commands used to retrieve the data from database is known as Data Query Language (DQL)). ,In each question there is a database having 3-4 tables and there are queries related to these tables and in the attached files there are the corrresponding commands for these queries.
# STATEMENTS USED
